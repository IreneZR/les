...
from les.drivers.compl_diff2_driver import search_tree
...
class ComplDiff2Driver(driver_base.DriverBase):

  def __init__(self, model, optimization_parameters, pipeline):
    super(ComplDiff2Driver, self).__init__()
    ...
    self._driver_params = optimization_parameters.driver.compl_diff2_driver_parameters
