...
from les.drivers.preproc_driver import search_tree
...
class PreprocDriver(driver_base.DriverBase):

  def __init__(self, model, optimization_parameters, pipeline):
    super(PreprocDriver, self).__init__()
    ...
    self._driver_params = optimization_parameters.driver.preproc_driver_parameters
